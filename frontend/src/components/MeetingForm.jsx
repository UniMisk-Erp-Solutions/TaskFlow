...
export default function MeetingForm({ onSubmit, onClose }) {
  ...
  async function handleSubmit(e) {
    ...
    if (!form.meeting_time) { setError('Meeting time is required'); return; }
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
            ...
            <div className="form-group">
              ...
              <input className="input" type="date" style={{ colorScheme: 'dark' }} value={form.meeting_date} onChange={(e) => set('meeting_date', e.target.value)} />
            </div>
          </div>

          <div className="form-group">
            <label className="form-label">Meeting Time</label>
            <input className="input" type="time" style={{ colorScheme: 'dark' }} value={form.meeting_time} onChange={(e) => set('meeting_time', e.target.value)} />
          </div>
