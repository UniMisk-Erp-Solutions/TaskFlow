      ...
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        <div className="max-w-none space-y-9 text-[var(--foreground)] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold tracking-tight font-display">1. Acceptance of Terms</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold tracking-tight font-display">2. Service Description</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold tracking-tight font-display">3. Account Responsibility</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold tracking-tight font-display">4. Content Ownership</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold tracking-tight font-display">5. Prohibited Use</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold tracking-tight font-display">6. Billing and Payments</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold tracking-tight font-display">7. Limitation of Liability</h2>
            <p>
